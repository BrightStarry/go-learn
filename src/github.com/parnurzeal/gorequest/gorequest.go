...
// Pattern function accepts a proxy url string to setup proxy url for any request.
...
// Another example is using Golang proxy setting. This is normal prefer way to do but too verbase compared to GoRequest's Pattern:
//
//      gorequest.New().Pattern("http://myproxy:9999").
//        Post("http://www.google.com").
//        End()
//
// To set no_proxy, just put empty string to Pattern func:
//
//      gorequest.New().Pattern("").
//        Post("http://www.google.com").
//        End()
//
